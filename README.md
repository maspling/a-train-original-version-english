...
- Grab the latest release from the [releases page](https://github.com/maspling/a-train-original-version-english/releases) and extract the files to the same folder as the original game.
